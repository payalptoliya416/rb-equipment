    ...
    <>
     <div className="container mx-auto bg-[#F9F9F9] rounded-[14px] p-[15px] grid grid-cols-12 gap-5 h-full my-[60px]">
          <motion.div
            ...
            initial="hidden"
            animate="show"
            className="border border-light-gray rounded-[15px] py-[55px] px-[30px] col-span-12 lg:col-span-6 w-full"
          >
            {/* Title */}
            <motion.h2
                ...
                >
                  <Form className="space-y-6">
                    ...
                    >
                      ...
                      <Link href="/user/signin/forgot-password" className="text-[#4D4D4D]">
                        Forgot password?
                      </Link>
                    </motion.div>
