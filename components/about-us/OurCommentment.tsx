...
function OurCommentment() {
  return (
   <section className="container-custom mx-auto lg:my-[110px] my-20">
                  <div className="grid grid-cols-12 lg:gap-[30px] items-center mt-10">
                    ...
                    <div className="col-span-12 lg:col-span-6 order-1 lg:order-2 mb-5 lg:mb-0">
                      ...
                      <p className="mb-[15px] text-[16px] leading-[26px] font-normal text-text-gray">
                        At RB Equipment Sales, our commitment goes beyond just buying and selling machines - it’s about building trust and long-term partnerships with every client we serve.
                      </p>
                      <p className="mb-[15px] text-[16px] leading-[26px] font-normal text-text-gray">
