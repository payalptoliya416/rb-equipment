               ...
               <div className="grid grid-cols-12 lg:gap-[30px] items-center mt-10">
                 ...
                 <div className="col-span-12 lg:col-span-6 order-1 lg:order-2 mb-5 lg:mb-0">
                   ...
                   <p className="mb-[15px] text-[16px] leading-[26px] font-normal text-text-gray">
                     Founded with a passion for machinery and a mission to simplify equipment trading, RB Equipment Sales has become a trusted name in the industrial marketplace. What started as a small regional operation has grown into a leading online destination for machinery buyers and sellers worldwide.
                   </p>
                   <p className="mb-[15px] text-[16px] leading-[26px] font-normal text-text-gray">
                   ...
                   <p className="mb-[15px] text-[16px] leading-[26px] font-normal text-text-gray">
                   At RB Equipment Sales, every listing represents more than just a machine — it’s a connection between people who build, create, and drive industries forward. We take pride in offering transparent descriptions, verified listings, and fair pricing, ensuring our customers always know exactly what they’re getting.
                   </p>
                 </div>
               </div>
       </section>
