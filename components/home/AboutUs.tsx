    ...
    <section className="container-custom mx-auto">
            <div className="grid grid-cols-12 lg:gap-[30px] items-center mt-10">
              ...
              <div className="col-span-12 lg:col-span-6 order-1 lg:order-2 mb-5 lg:mb-0">
                <h4 className="mb-5 text-orange text-lg font-bold relative after:absolute after:top-3 after:left-0 after:bg-orange after:w-[15px] after:h-[2px] pl-5 after:rounded-full"> About Us</h4>
