        ...
        <div className="container-custom mx-auto ">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
            <div className="bg-white border border-light-gray rounded-xl p-[30px]">
              <div className="flex justify-between items-center mb-5 flex-col sm:flex-row gap-3 sm:gap-1">
                <div className="flex items-center gap-[15px]">
                  ...
                  />
                  <div>
                    <h3 className="text-gray text-lg leading-[20px] mb-[10px] font-bold">
                      Robert Fox
                    </h3>
              ...
              <p className="text-base leading-[26px] text-text-gray font-normal">
                ...
                Their team handled everything professionally, and I received
                great value within days. Highly recommended!”
              </p>
            </div>
            <div className="bg-white border border-light-gray rounded-xl p-[30px]">
              <div className="flex justify-between items-center mb-5 flex-col sm:flex-row gap-3 sm:gap-1">
              ...
              <p className="text-base leading-[26px] text-text-gray font-normal">
                “Fantastic experience from start to finish! The website is easy
                to use, and the support team helped me find the perfect
            ...
            <div className="bg-white border border-light-gray rounded-xl p-[30px]">
              ...
              <p className="text-base leading-[26px] text-text-gray font-normal">
                “RB Equipment Sales made the entire buying process easy.
                Excellent communication, transparent bidding, and fast delivery.
                I’ll definitely return for my next equipment purchase!”
              </p>
            </div>
          </div>
        </div>
