          ...
          {[
            {
              ...
              text: "“Selling my machinery through RB Equipment Sales was seamless. Their team handled everything professionally, and I received great value within days. Highly recommended!”",
            },
            {
            ...
            },
            {
              ...
              name: "Jerome Bell",
              role: "Owner",
              text: "“I participated in my first online auction with RB Equipment Sales, and it was incredibly smooth, transparent, and secure. Highly trustworthy and efficient service!”",
            },
            {
              img: "/assets/client4.png",
              name: "Jenny Wilson",
              role: "Construction Manager",
              text: "“RB Equipment Sales made the entire buying process easy. Excellent communication, transparent bidding, and fast delivery. I’ll definitely return for my next equipment purchase!”",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
